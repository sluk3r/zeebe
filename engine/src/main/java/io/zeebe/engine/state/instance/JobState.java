...
public final class JobState {
  ...
  private final JobRecordValue jobRecordToRead;
  private final JobRecordValue jobRecordToWrite;
  ...
  public JobState(
    ...
    jobRecordToRead = new JobRecordValue();
    jobRecordToWrite = new JobRecordValue();
    jobKey = new DbLong();
    jobsColumnFamily =
  ...
  public JobRecord getJob(final long key) {
    jobKey.wrapLong(key);
    final JobRecordValue jobRecord = jobsColumnFamily.get(jobKey);
    return jobRecord == null ? null : jobRecord.get();
  }
  ...
  private void resetVariablesAndUpdateJobRecord(final long key, final JobRecord updatedValue) {
    ...
    jobRecordToWrite.set(updatedValue);
