...
public final class MessageStartEventSubscriptionState {
  ...
  private final ColumnFamily<DbCompositeKey<DbString, DbLong>, MessageStartSubscriptionRecordValue>
      subscriptionsColumnFamily;
  private final MessageStartSubscriptionRecordValue subscriptionValue;
  ...
  public MessageStartEventSubscriptionState(
    ...
    subscriptionValue = new MessageStartSubscriptionRecordValue();
