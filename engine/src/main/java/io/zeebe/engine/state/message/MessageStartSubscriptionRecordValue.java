...
public class MessageStartSubscriptionRecordValue extends UnpackedObject implements DbValue {
  private final ObjectProperty<MessageStartEventSubscriptionRecord> recordProp =
      new ObjectProperty<>("record", new MessageStartEventSubscriptionRecord());

  public MessageStartSubscriptionRecordValue() {
