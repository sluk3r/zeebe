...
public final class OAuthCredentialsProviderTest {
  ...
  public void shouldUseClientContactPointAsDefaultAudience() {
    ...
    WireMock.verify(
        WireMock.postRequestedFor(WireMock.urlPathEqualTo("/oauth/token"))
            ...
            .withQueryParam("client_secret", WireMock.equalTo(SECRET))
            .withQueryParam("client_id", WireMock.equalTo(CLIENT_ID))
            .withQueryParam("audience", WireMock.equalTo(contactPointHost))
  ...
  private void mockCredentials(final String accessToken, final String audience) {
    final HashMap<String, StringValuePattern> map = new HashMap<>();
    map.put("client_secret", WireMock.equalTo(SECRET));
    map.put("client_id", WireMock.equalTo(CLIENT_ID));
    map.put("audience", WireMock.equalTo(audience));
    map.put("grant_type", WireMock.equalTo("client_credentials"));
